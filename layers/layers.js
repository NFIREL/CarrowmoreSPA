...
lyr_EdgeofRoad2kmBufferStudyArea_1.set('fieldLabels', {'FID': 'no label', 'Details': 'no label', });
lyr_ProposedNaturalHeritageAreasin2km_2.set('fieldLabels', {'OBJECTID': 'no label', 'SITECODE': 'no label', 'SITE_NAME': 'no label', 'COUNTY': 'no label', 'VERSION': 'no label', 'HA': 'no label', 'Source_CRS': 'no label', 'SourcScale': 'no label', 'URL': 'no label', 'Shape__Are': 'no label', 'Shape__Len': 'no label', });
lyr_SpecialAreaofConservationin2km_3.set('fieldLabels', {'OBJECTID': 'no label', 'SITECODE': 'no label', 'SITE_NAME': 'no label', 'VERSION': 'no label', 'COUNTY': 'no label', 'HA': 'no label', 'Source_CRS': 'no label', 'SourcScale': 'no label', 'URL': 'no label', 'Shape__Are': 'no label', 'Shape__Len': 'no label', });
lyr_RiverWaterBodiesin2km_4.set('fieldLabels', {'EU_CD': 'no label', 'NAME': 'no label', 'MS_CD': 'no label', 'REGION_CD': 'no label', 'INS_WHEN': 'no label', 'INS_BY': 'no label', 'BASIN_CD': 'no label', 'LAT': 'no label', 'LON': 'no label', 'LENGTHKM': 'no label', 'SUB_CD': 'no label', 'DateChange': 'no label', 'Change': 'no label', 'GEOLOGY': 'no label', 'AreaKm2': 'no label', 'AreaHectar': 'no label', 'Slope': 'no label', 'Altitude': 'no label', 'WaterManag': 'no label', 'EdenEntity': 'no label', 'Easting': 'no label', 'Northing': 'no label', 'LocalAutho': 'no label', 'SYSTEM': 'no label', 'TYPE': 'no label', 'ALT_CAT': 'no label', 'SIZE_CAT': 'no label', 'DIST_CD': 'no label', 'ProtectedA': 'no label', 'WiseRefere': 'no label', 'HydroArea': 'no label', 'StnDefinin': 'no label', });
lyr_TailteEireannSingleStreamsin2km_5.set('fieldLabels', {'fid': 'no label', 'GUID': 'no label', 'OBJECTID': 'no label', });
lyr_SMRZonesin2km_6.set('fieldLabels', {'OBJECTID': 'no label', 'ZONE_ID': 'no label', 'Shape__Are': 'no label', 'Shape__Len': 'no label', });
lyr_SMROpenDatain2km_7.set('fieldLabels', {'OBJECTID': 'no label', 'ENTITY_ID': 'no label', 'CLASS_CODE': 'no label', 'SMRS': 'no label', 'COUNTY': 'no label', 'TOWNLAND': 'no label', 'ZONE_ID_1': 'no label', 'ITM_E': 'no label', 'ITM_N': 'no label', 'LONGITUDE': 'no label', 'LATITUDE': 'no label', 'MONUMENT_C': 'no label', 'FIRST_EDIT': 'no label', 'LATEST_EDI': 'no label', 'WEBSITE_LI': 'no label', 'WEB_NOTES': 'no label', 'REFERENCES': 'no label', });
lyr_SPAClippedtoLandowners_8.set('fieldLabels', {'localid': 'no label', 'SPAName': 'no label', 'SPAFolio': 'no label', 'SPADetails': 'no label', 'SPAAddress': 'no label', 'Work': 'no label', 'Severity': 'no label', 'Photo': 'no label', 'Area (Ha)': 'no label', 'Area (Ac)': 'no label', 'Area (SqM)': 'no label', });
lyr_RoadEdgefromRoadSurvey_9.set('fieldLabels', {'FID': 'no label', 'Details': 'no label', });
lyr_WallsfromRoadSurvey_10.set('fieldLabels', {'Details': 'no label', });
lyr_FencefromRoadSurvey_11.set('fieldLabels', {'Details': 'no label', });
lyr_VegetationfromRoadSurvey_12.set('fieldLabels', {'Details': 'no label', });
lyr_OHLfromRoadSurvey_13.set('fieldLabels', {'Details': 'no label', });
